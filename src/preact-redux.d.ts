...
declare module 'preact-redux' {
  ...
  export interface InferableComponentEnhancerWithProps<
    ...
    TNeedsProps
  > {
    <P extends TInjectedProps, T extends AnyComponent<P, {}>>(
      component: T
    ): ComponentConstructor<Omit<P, keyof TInjectedProps> & TNeedsProps, {}> & T
  }
   ...
   * @param options
   */
  export function connect(): InferableComponentEnhancer<DispatchProp<any>>
