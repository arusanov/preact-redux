...
selectorFactory) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    invariant$4(typeof WrappedComponent == 'function', 'You must pass a component to the function returned by ' + ('connect. Instead received ' + JSON.stringify(WrappedComponent)));
    ...
    var Connect = function (_Component) {
      ...
      function Connect(props, context) {
        ...
        invariant$4(_this.store, 'Could not find "' + storeKey + '" in either the context or props of ' + ('"' + displayName + '". Either wrap the root component in a <Provider>, ') + ('or explicitly pass "' + storeKey + '" as a prop to "' + displayName + '".'));
      ...
      Connect.prototype.getWrappedInstance = function getWrappedInstance() {
        invariant$4(withRef, 'To access the wrapped instance, you need to specify ' + ('{ withRef: true } in the options argument of the ' + methodName + '() call.'));
